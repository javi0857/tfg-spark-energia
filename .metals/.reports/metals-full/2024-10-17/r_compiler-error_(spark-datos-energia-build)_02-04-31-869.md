file:///C:/Proyectos/spark-datos-energia/build.sbt
### file%3A%2F%2F%2FC%3A%2FProyectos%2Fspark-datos-energia%2Fbuild.sbt:28: error: `)` expected but `.` found
  Dependencies.munit,
              ^
...
action parameters:
uri: file:///C:/Proyectos/spark-datos-energia/build.sbt
text:
```scala
...
libraryDependencies ++= Seq(
  ...
  "org.apache.hadoop" % "hadoop-common" % "3.2.0",  // Asegúrate de usar una versión reciente de Hadoop
